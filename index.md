---
layout: default
title: "Alpha60 Swarm Results 2020"
...
- Media Objects
{% capture media_objects %}{% include year-2020-0-media-objects.txt %}{% endcapture %}{{ media_objects | replace: '.md)', '.html)' }}
...
- [Year-2020 data](https://github.com/alpha60-devops/alpha60-results-2020/tree/main/data)
