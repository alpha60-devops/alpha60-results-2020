...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/black-is-king-cumulative-aggregate.geojson.gz" data-map-title="Black Is King — black-is-king" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Black Is King (black-is-king) cumulative data map in new window" title="Opens interactive map for Black Is King (black-is-king) data">Swarm Detail</a>
