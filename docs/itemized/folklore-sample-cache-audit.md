...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/folklore-cumulative-aggregate.geojson.gz" data-map-title="Folklore — folklore" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Folklore (folklore) cumulative data map in new window" title="Opens interactive map for Folklore (folklore) data">Swarm Detail</a>
