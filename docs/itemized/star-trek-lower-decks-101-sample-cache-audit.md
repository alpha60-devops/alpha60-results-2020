...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/star-trek-lower-decks-101-cumulative-aggregate.geojson.gz" data-map-title="Star Trek: Lower Decks — star-trek-lower-decks-101" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Star Trek: Lower Decks (star-trek-lower-decks-101) cumulative data map in new window" title="Opens interactive map for Star Trek: Lower Decks (star-trek-lower-decks-101) data">Swarm Detail</a>
