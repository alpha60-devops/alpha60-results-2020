...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/good-fight-407-cumulative-aggregate.geojson.gz" data-map-title="The Good Fight — good-fight-407" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Good Fight (good-fight-407) cumulative data map in new window" title="Opens interactive map for The Good Fight (good-fight-407) data">Swarm Detail</a>
