...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/mandalorian-208-cumulative-aggregate.geojson.gz" data-map-title="The Mandalorian — mandalorian-208" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Mandalorian (mandalorian-208) cumulative data map in new window" title="Opens interactive map for The Mandalorian (mandalorian-208) data">Swarm Detail</a>
