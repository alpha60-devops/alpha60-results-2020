...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/westworld-308-cumulative-aggregate.geojson.gz" data-map-title="Westworld — westworld-308" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Westworld (westworld-308) cumulative data map in new window" title="Opens interactive map for Westworld (westworld-308) data">Swarm Detail</a>
