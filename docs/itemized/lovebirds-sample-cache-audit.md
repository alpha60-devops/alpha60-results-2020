...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/lovebirds-cumulative-aggregate.geojson.gz" data-map-title="The Lovebirds — lovebirds" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Lovebirds (lovebirds) cumulative data map in new window" title="Opens interactive map for The Lovebirds (lovebirds) data">Swarm Detail</a>
