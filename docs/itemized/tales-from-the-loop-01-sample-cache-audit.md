...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2020/refs/heads/main/data/geojson.cumulative/tales-from-the-loop-01-cumulative-aggregate.geojson.gz" data-map-title="Tales From The Loop — tales-from-the-loop-01" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Tales From The Loop (tales-from-the-loop-01) cumulative data map in new window" title="Opens interactive map for Tales From The Loop (tales-from-the-loop-01) data">Swarm Detail</a>
